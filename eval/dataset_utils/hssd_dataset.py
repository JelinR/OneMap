...
def load_hssd_episodes(episodes: List[Episode], scene_data: Dict[str, SceneData], object_nav_path: str):
    i = 0
...
# def load_hssd_objects(scene_data: Dict[str, SceneData], semantic_objects, scene_id: str):


#     for scene_obj in scene_data[scene_id].object_locations.keys():
...
if __name__ == '__main__':
    eps, scene_data = load_hssd_episodes([], {}, "datasets/objectnav/hssd/val_rare/content")
